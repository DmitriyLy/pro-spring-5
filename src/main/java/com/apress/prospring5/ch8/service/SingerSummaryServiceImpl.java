...
public class SingerSummaryServiceImpl implements SingerSummaryService {
    ...
    public List<SingerSummary> findAll() {
        return entityManager.createQuery("select new com.apress.prospring5.ch8.view.SingerSummary(" +
                        "s.firstName, s.lastName, a.title) from Singer s left join s.albums a " +
